...
//     selectedPost.shareText + " " + selectedPost.link
//   );
...
//     selectedPost.title + " " + selectedPost.link
//   )}`;
...
//   const pinterestShareUrl = `https://www.pinterest.com/pin/create/button/?url=&media=${encodeURIComponent(
//     imageUrl
...
//       absoluteImageUrl
//     )}&description=${encodeURIComponent(selectedPost.title)}`;
